# Network services 2 (NFS, SMTP, and MySQL) [URL](https://tryhackme.com/r/room/networkservices2)
...
4. **Mounting the Share**:Mount the NFS share locally to access its contents.
